...
public class ChiTietNganChanResource {
    ...
    private static final String ENTITY_NAME = "duongSuChiTietNganChan";
    ...
    public ChiTietNganChanResource(ChiTietNganChanService chiTietNganChanService, ChiTietNganChanRepository chiTietNganChanRepository) {
     ...
     */
    @GetMapping("")
    public List<ChiTietNganChanDTO> getAllChiTietNganChans() {
        LOG.debug("REST request to get all ChiTietNganChans");
        return chiTietNganChanService.findAll();
    }
