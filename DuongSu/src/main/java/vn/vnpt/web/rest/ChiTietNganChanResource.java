...
public class ChiTietNganChanResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ChiTietNganChanDTO>> getAllChiTietNganChans(
        ChiTietNganChanCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get ChiTietNganChans by criteria: {}", criteria);

        Page<ChiTietNganChanDTO> page = chiTietNganChanQueryService.findByCriteria(criteria, pageable);
