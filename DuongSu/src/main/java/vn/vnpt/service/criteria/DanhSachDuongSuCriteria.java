...
/**
 * Criteria class for the {@link vn.vnpt.domain.DanhSachDuongSu} entity. This class is used
 * in {@link vn.vnpt.web.rest.DanhSachDuongSuResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /danh-sach-duong-sus?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DanhSachDuongSuCriteria implements Serializable, Criteria {
    ...
    public DanhSachDuongSuCriteria() {}

    public DanhSachDuongSuCriteria(DanhSachDuongSuCriteria other) {
    ...
    @Override
    public DanhSachDuongSuCriteria copy() {
        return new DanhSachDuongSuCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DanhSachDuongSuCriteria that = (DanhSachDuongSuCriteria) o;
        return (
    ...
    public String toString() {
        return "DanhSachDuongSuCriteria{" +
