...
class TaiSanDuongSuTest {
    ...
    void idDuongSuTest() {
        ...
        taiSanDuongSu.setIdDuongSu(duongSuBack);
        assertThat(taiSanDuongSu.getIdDuongSu()).isEqualTo(duongSuBack);

        taiSanDuongSu.idDuongSu(null);
        assertThat(taiSanDuongSu.getIdDuongSu()).isNull();
    }
}
