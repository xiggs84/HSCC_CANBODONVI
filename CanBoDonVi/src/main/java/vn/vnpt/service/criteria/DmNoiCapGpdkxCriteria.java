...
/**
 * Criteria class for the {@link vn.vnpt.domain.DmNoiCapGpdkx} entity. This class is used
 * in {@link vn.vnpt.web.rest.DmNoiCapGpdkxResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /dm-noi-cap-gpdkxes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DmNoiCapGpdkxCriteria implements Serializable, Criteria {
    ...
    public DmNoiCapGpdkxCriteria() {}

    public DmNoiCapGpdkxCriteria(DmNoiCapGpdkxCriteria other) {
    ...
    @Override
    public DmNoiCapGpdkxCriteria copy() {
        return new DmNoiCapGpdkxCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DmNoiCapGpdkxCriteria that = (DmNoiCapGpdkxCriteria) o;
        return (
