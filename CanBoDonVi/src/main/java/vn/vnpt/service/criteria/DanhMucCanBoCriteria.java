...
public class DanhMucCanBoCriteria implements Serializable, Criteria {
    ...
    private StringFilter soGiayToTuyThan;
    ...
    public DanhMucCanBoCriteria(DanhMucCanBoCriteria other) {
        ...
        this.soGiayToTuyThan = other.optionalSoGiayToTuyThan().map(StringFilter::copy).orElse(null);
    ...
    public StringFilter getSoGiayToTuyThan() {
        return soGiayToTuyThan;
    }

    public Optional<StringFilter> optionalSoGiayToTuyThan() {
        return Optional.ofNullable(soGiayToTuyThan);
    }

    public StringFilter soGiayToTuyThan() {
        if (soGiayToTuyThan == null) {
            setSoGiayToTuyThan(new StringFilter());
        }
        return soGiayToTuyThan;
    }

    public void setSoGiayToTuyThan(StringFilter soGiayToTuyThan) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(soGiayToTuyThan, that.soGiayToTuyThan) &&
    ...
    public String toString() {
        return "DanhMucCanBoCriteria{" +
            ...
            optionalSoGiayToTuyThan().map(f -> "soGiayToTuyThan=" + f + ", ").orElse("") +
