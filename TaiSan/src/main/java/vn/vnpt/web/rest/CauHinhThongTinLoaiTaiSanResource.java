...
public class CauHinhThongTinLoaiTaiSanResource {
     ...
     */
    @GetMapping("")
    public List<CauHinhThongTinLoaiTaiSanDTO> getAllCauHinhThongTinLoaiTaiSans() {
        LOG.debug("REST request to get all CauHinhThongTinLoaiTaiSans");
        return cauHinhThongTinLoaiTaiSanService.findAll();
    }
