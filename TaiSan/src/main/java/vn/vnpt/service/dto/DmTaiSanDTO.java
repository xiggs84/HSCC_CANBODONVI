...
/**
 * A DTO for the {@link vn.vnpt.domain.DmTaiSan} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DmTaiSanDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DmTaiSanDTO)) {
            return false;
        }

        DmTaiSanDTO dmTaiSanDTO = (DmTaiSanDTO) o;
        if (this.idTaiSan == null) {
            return false;
        }
        return Objects.equals(this.idTaiSan, dmTaiSanDTO.idTaiSan);
    }
