 ...
 */
@Entity
@Table(name = "dm_tai_san")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DmTaiSan implements Serializable {
    ...
    public DmTaiSan idTaiSan(Long idTaiSan) {
    ...
    public DmTaiSan tenTaiSan(String tenTaiSan) {
    ...
    public DmTaiSan trangThai(Long trangThai) {
    ...
    public DmTaiSan thongTinTs(String thongTinTs) {
    ...
    public DmTaiSan ghiChu(String ghiChu) {
    ...
    public DmTaiSan ngayThaoTac(LocalDate ngayThaoTac) {
    ...
    public DmTaiSan nguoiThaoTac(Long nguoiThaoTac) {
    ...
    public DmTaiSan idDuongSu(Long idDuongSu) {
    ...
    public DmTaiSan idTsGoc(Long idTsGoc) {
    ...
    public DmTaiSan maTaiSan(String maTaiSan) {
    ...
    public DmTaiSan idLoaiNganChan(Long idLoaiNganChan) {
    ...
    public DmTaiSan ngayBdNganChan(LocalDate ngayBdNganChan) {
    ...
    public DmTaiSan ngayKtNganChan(LocalDate ngayKtNganChan) {
    ...
    public DmTaiSan idMaster(Long idMaster) {
    ...
    public DmTaiSan strSearch(String strSearch) {
    ...
    public DmTaiSan idDonVi(Long idDonVi) {
    ...
    public DmTaiSan soHsCv(Long soHsCv) {
    ...
    public DmTaiSan soCc(Long soCc) {
        this.setSoCc(soCc);
        return this;
    }
    ...
    public DmTaiSan soVaoSo(Long soVaoSo) {
    ...
    public DmTaiSan moTa(String moTa) {
        this.setMoTa(moTa);
        return this;
    }
    ...
    public DmTaiSan loaiNganChan(Long loaiNganChan) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DmTaiSan)) {
            return false;
        }
        return getIdTaiSan() != null && getIdTaiSan().equals(((DmTaiSan) o).getIdTaiSan());
    }
