...
class TaiSanCriteriaTest {
    ...
    private static void setAllFilters(TaiSanCriteria taiSanCriteria) {
        ...
        taiSanCriteria.thuaTachId();
        taiSanCriteria.taiSanDuongSuId();
        taiSanCriteria.taiSanDgcId();
        taiSanCriteria.thongTinCapNhatTaiSanId();
        taiSanCriteria.danhMucLoaiTaiSanId();
        taiSanCriteria.tinhTrangTaiSanId();
        taiSanCriteria.chiTietNganChanTaiSanId();
    ...
    private static Condition<TaiSanCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getThuaTachId()) &&
                ...
                condition.apply(criteria.getTinhTrangTaiSanId()) &&
                condition.apply(criteria.getChiTietNganChanTaiSanId()) &&
    ...
    private static Condition<TaiSanCriteria> copyFiltersAre(TaiSanCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getThuaTachId(), copy.getThuaTachId()) &&
                ...
                condition.apply(criteria.getTinhTrangTaiSanId(), copy.getTinhTrangTaiSanId()) &&
                condition.apply(criteria.getChiTietNganChanTaiSanId(), copy.getChiTietNganChanTaiSanId()) &&
