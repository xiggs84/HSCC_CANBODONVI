...
class CauHinhThongTinLoaiTaiSanResourceIT {
     ...
     */
    public static CauHinhThongTinLoaiTaiSan createEntity() {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CauHinhThongTinLoaiTaiSan createUpdatedEntity() {
        return new CauHinhThongTinLoaiTaiSan()
    ...
    public void initTest() {
        cauHinhThongTinLoaiTaiSan = createEntity();
    }
    ...
    void partialUpdateCauHinhThongTinLoaiTaiSanWithPatch() throws Exception {
        ...
        partialUpdatedCauHinhThongTinLoaiTaiSan.javascript(UPDATED_JAVASCRIPT).trangThai(UPDATED_TRANG_THAI).xml(UPDATED_XML);
