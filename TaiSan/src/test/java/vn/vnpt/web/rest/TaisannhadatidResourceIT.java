...
class TaisannhadatidResourceIT {
     ...
     */
    public static Taisannhadatid createEntity() {
        return new Taisannhadatid().thongTinTs(DEFAULT_THONG_TIN_TS);
    }
     ...
     * if they test an entity which requires the current entity.
     */
    public static Taisannhadatid createUpdatedEntity() {
        return new Taisannhadatid().thongTinTs(UPDATED_THONG_TIN_TS);
    }

    @BeforeEach
    public void initTest() {
        taisannhadatid = createEntity();
    }
    ...
    void getAllTaisannhadatids() throws Exception {
        ...
        restTaisannhadatidMockMvc
            ...
            .andExpect(jsonPath("$.[*].idTaiSan").value(hasItem(taisannhadatid.getIdTaiSan().intValue())))
    ...
    void getTaisannhadatid() throws Exception {
        ...
        restTaisannhadatidMockMvc
            .perform(get(ENTITY_API_URL_ID, taisannhadatid.getIdTaiSan()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.idTaiSan").value(taisannhadatid.getIdTaiSan().intValue()))
    ...
    void putExistingTaisannhadatid() throws Exception {
        ...
        Taisannhadatid updatedTaisannhadatid = taisannhadatidRepository.findById(taisannhadatid.getIdTaiSan()).orElseThrow();
        ...
        updatedTaisannhadatid.thongTinTs(UPDATED_THONG_TIN_TS);
        TaisannhadatidDTO taisannhadatidDTO = taisannhadatidMapper.toDto(updatedTaisannhadatid);

        restTaisannhadatidMockMvc
            .perform(
                put(ENTITY_API_URL_ID, taisannhadatidDTO.getIdTaiSan())
    ...
    void putNonExistingTaisannhadatid() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        taisannhadatid.setIdTaiSan(longCount.incrementAndGet());
    ...
    void partialUpdateTaisannhadatidWithPatch() throws Exception {
        ...
        partialUpdatedTaisannhadatid.setIdTaiSan(taisannhadatid.getIdTaiSan());

        partialUpdatedTaisannhadatid.thongTinTs(UPDATED_THONG_TIN_TS);

        restTaisannhadatidMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedTaisannhadatid.getIdTaiSan())
    ...
    void patchNonExistingTaisannhadatid() throws Exception {
        ...
        restTaisannhadatidMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, taisannhadatidDTO.getIdTaiSan())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(taisannhadatidDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteTaisannhadatid() throws Exception {
        ...
        restTaisannhadatidMockMvc
            .perform(delete(ENTITY_API_URL_ID, taisannhadatid.getIdTaiSan()).accept(MediaType.APPLICATION_JSON))
    ...
    protected Taisannhadatid getPersistedTaisannhadatid(Taisannhadatid taisannhadatid) {
        return taisannhadatidRepository.findById(taisannhadatid.getIdTaiSan()).orElseThrow();
    }
