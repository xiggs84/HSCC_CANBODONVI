...
class TaisanSaiDgcResourceIT {
     ...
     */
    public static TaisanSaiDgc createEntity() {
        return new TaisanSaiDgc().idMaster(DEFAULT_ID_MASTER).thongTinTs(DEFAULT_THONG_TIN_TS).thongTinTsDung(DEFAULT_THONG_TIN_TS_DUNG);
    }
     ...
     * if they test an entity which requires the current entity.
     */
    public static TaisanSaiDgc createUpdatedEntity() {
        return new TaisanSaiDgc().idMaster(UPDATED_ID_MASTER).thongTinTs(UPDATED_THONG_TIN_TS).thongTinTsDung(UPDATED_THONG_TIN_TS_DUNG);
    }

    @BeforeEach
    public void initTest() {
        taisanSaiDgc = createEntity();
    }
    ...
    void partialUpdateTaisanSaiDgcWithPatch() throws Exception {
        ...
        partialUpdatedTaisanSaiDgc.idMaster(UPDATED_ID_MASTER);
