...
class TaisanSaiQsddDgcResourceIT {
     ...
     */
    public static TaisanSaiQsddDgc createEntity() {
        return new TaisanSaiQsddDgc().idMaster(DEFAULT_ID_MASTER).noiCapQsdd(DEFAULT_NOI_CAP_QSDD);
    }
     ...
     * if they test an entity which requires the current entity.
     */
    public static TaisanSaiQsddDgc createUpdatedEntity() {
        return new TaisanSaiQsddDgc().idMaster(UPDATED_ID_MASTER).noiCapQsdd(UPDATED_NOI_CAP_QSDD);
    }

    @BeforeEach
    public void initTest() {
        taisanSaiQsddDgc = createEntity();
    }
