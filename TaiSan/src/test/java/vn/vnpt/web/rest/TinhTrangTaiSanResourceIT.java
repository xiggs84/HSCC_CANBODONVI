...
class TinhTrangTaiSanResourceIT {
    ...
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{idTinhTrang}";
     ...
     */
    public static TinhTrangTaiSan createEntity() {
        return new TinhTrangTaiSan().dienGiai(DEFAULT_DIEN_GIAI).trangThai(DEFAULT_TRANG_THAI);
    }
     ...
     * if they test an entity which requires the current entity.
     */
    public static TinhTrangTaiSan createUpdatedEntity() {
        return new TinhTrangTaiSan().dienGiai(UPDATED_DIEN_GIAI).trangThai(UPDATED_TRANG_THAI);
    }

    @BeforeEach
    public void initTest() {
        tinhTrangTaiSan = createEntity();
    }
    ...
    void createTinhTrangTaiSanWithExistingId() throws Exception {
        ...
        tinhTrangTaiSan.setIdTinhTrang(1L);
        TinhTrangTaiSanDTO tinhTrangTaiSanDTO = tinhTrangTaiSanMapper.toDto(tinhTrangTaiSan);
    ...
    void getAllTinhTrangTaiSans() throws Exception {
        ...
        restTinhTrangTaiSanMockMvc
            .perform(get(ENTITY_API_URL + "?sort=idTinhTrang,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].idTinhTrang").value(hasItem(tinhTrangTaiSan.getIdTinhTrang().intValue())))
    ...
    void getTinhTrangTaiSan() throws Exception {
        ...
        restTinhTrangTaiSanMockMvc
            .perform(get(ENTITY_API_URL_ID, tinhTrangTaiSan.getIdTinhTrang()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.idTinhTrang").value(tinhTrangTaiSan.getIdTinhTrang().intValue()))
    ...
    void putExistingTinhTrangTaiSan() throws Exception {
        ...
        TinhTrangTaiSan updatedTinhTrangTaiSan = tinhTrangTaiSanRepository.findById(tinhTrangTaiSan.getIdTinhTrang()).orElseThrow();
        ...
        updatedTinhTrangTaiSan.dienGiai(UPDATED_DIEN_GIAI).trangThai(UPDATED_TRANG_THAI);
        TinhTrangTaiSanDTO tinhTrangTaiSanDTO = tinhTrangTaiSanMapper.toDto(updatedTinhTrangTaiSan);

        restTinhTrangTaiSanMockMvc
            .perform(
                put(ENTITY_API_URL_ID, tinhTrangTaiSanDTO.getIdTinhTrang())
    ...
    void putNonExistingTinhTrangTaiSan() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        tinhTrangTaiSan.setIdTinhTrang(longCount.incrementAndGet());
    ...
    void partialUpdateTinhTrangTaiSanWithPatch() throws Exception {
        ...
        partialUpdatedTinhTrangTaiSan.setIdTinhTrang(tinhTrangTaiSan.getIdTinhTrang());

        restTinhTrangTaiSanMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedTinhTrangTaiSan.getIdTinhTrang())
    ...
    void fullUpdateTinhTrangTaiSanWithPatch() throws Exception {
        ...
        partialUpdatedTinhTrangTaiSan.dienGiai(UPDATED_DIEN_GIAI).trangThai(UPDATED_TRANG_THAI);
    ...
    void patchNonExistingTinhTrangTaiSan() throws Exception {
        ...
        restTinhTrangTaiSanMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, tinhTrangTaiSanDTO.getIdTinhTrang())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(tinhTrangTaiSanDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteTinhTrangTaiSan() throws Exception {
        ...
        restTinhTrangTaiSanMockMvc
            .perform(delete(ENTITY_API_URL_ID, tinhTrangTaiSan.getIdTinhTrang()).accept(MediaType.APPLICATION_JSON))
    ...
    protected TinhTrangTaiSan getPersistedTinhTrangTaiSan(TinhTrangTaiSan tinhTrangTaiSan) {
        return tinhTrangTaiSanRepository.findById(tinhTrangTaiSan.getIdTinhTrang()).orElseThrow();
    }
