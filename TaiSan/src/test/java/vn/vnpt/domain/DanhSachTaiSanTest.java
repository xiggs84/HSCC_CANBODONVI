...
class DanhSachTaiSanTest {
    ...
    void danhMucLoaiTaiSanTest() {
        ...
        danhSachTaiSan.setDanhMucLoaiTaiSan(danhMucLoaiTaiSanBack);
        assertThat(danhSachTaiSan.getDanhMucLoaiTaiSan()).isEqualTo(danhMucLoaiTaiSanBack);

        danhSachTaiSan.danhMucLoaiTaiSan(null);
        assertThat(danhSachTaiSan.getDanhMucLoaiTaiSan()).isNull();
    }
}
